#ifndef SPAN_SRC_SPAN_THIRD_PARTY_SLIMSIG_TRACKED_CONNECT_HH_
#define SPAN_SRC_SPAN_THIRD_PARTY_SLIMSIG_TRACKED_CONNECT_HH_
...
#endif  // SPAN_SRC_SPAN_THIRD_PARTY_SLIMSIG_TRACKED_CONNECT_HH_
